 ...
 *
 */
public class P2PKeyboardThread extends KeyboardThread {
    /**
     ...
     */
    public P2PKeyboardThread(Chat.Server.NetManager _serverNetManager, Chat.Client.NetManager _clientNetManager) {
        super();
