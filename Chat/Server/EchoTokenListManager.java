...
/**
 * Created by benwa on 6/19/14.
 */
public class EchoTokenListManager extends EchoListManager {
    /**
     * Basic constructor
     * @param netManager The NetManager we will use to send our messages
     */
    public EchoTokenListManager(NetManager netManager) {
        super(netManager);
    }
    ...
    protected ArrayList<Serializable> getNodeData() {
        ...
        if( netManager.getLockManager().getHasToken()) {
            res.add(p);
        }
        return res;
    }
